  ...
  return (
    <header className="h-16 border-b border-border glass-strong flex items-center gap-4 px-6 sticky top-0 z-30">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs uppercase tracking-widest text-muted-foreground">Realtime</span>
      ...
      <div className="flex-1 max-w-md mx-auto">
        <div className="relative">
          ...
          <input
            placeholder="Buscar pedido, cliente ou entregador…"
      ...
      <button className="relative size-9 rounded-lg border border-border hover:border-border-strong flex items-center justify-center">
      ...
      <div className="flex items-center gap-3 pl-3 border-l border-border">
        <div className="text-right hidden sm:block">
          ...
          <div className="text-[10px] text-muted-foreground mt-1">Dispatcher · turno ativo</div>
        </div>
        ...
        <button
          ...
          title="Sair"
          className="size-9 rounded-lg border border-border hover:border-border-strong flex items-center justify-center text-muted-foreground hover:text-foreground transition"
        >
